...
export default function Hero(){
    return(
        <div className="pt-4 lg:pt-10">
            ...
            Get a clear overview with our customizable dashboard and stay in control.
             Transform your workflow with features designed to boost productivity and efficiency!
            </p>
            <div className="flex w-full pt-8 justify-center gap-x-5">
                <button className="bg-[#4328EB] w-1/2 py-4 px-8 hover:bg-blue-700 text-white
                ...
                View Pricing 
                <span><Image src={BlueArrow } alt="learn more "/></span></button>
            </div>
            </div>
                    ...
                    <div className="flex w-full flex-col items-center lg:container lg:flex-row lg:justify-between lg:px-20 ">
                        ...
                        <div className="grid grid-cols-3 items-center justify-center justify-items-center px[20px] align-middle lg:grid-cols-5">
                            <Link href="/"><Image src={Google} alt=""/></Link>
                             <Link href="/"> <Image src={Slack} alt=""/></Link>
                            <Link href="/"><Image src={truspiolot} alt=""/></Link>
                             <Link href="/"><Image src={CNN} alt=""/></Link>
                             <Link href=""><Image src={cluth} alt=""/></Link>
