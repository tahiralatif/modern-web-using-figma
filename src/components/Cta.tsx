    ...
    return(
        ...
        px-[32px] text-center lg:my-[60px] lg:px-[324px] lg:py-[89px]">
            ...
            <div className="mt-[40px] flex flex-col w-full items-center lg:mt-[56px] lg:flex-row lg:justify-center lg:gap-x-[40px]">
                <button className="py-[16px] px-[32px] bg-white rounded-[4px] text-pink-500 w-fit lg:font-medium">
                    Try for free</button>
                <button className="flex justify-center items-center gap-x-3 mt-[32px] text-white font-medium lg:w-fit lg:mt-0 lg:font-medium">Contact Sales <span><Image src={arrow} alt=" learn more"/></span></button>
            </div>
