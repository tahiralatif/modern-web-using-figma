    ...
    return(
        <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-20">
            <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
                <Image src={Feature1} alt="image 1" 
                ...
                <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
                    ...
                    <p className="py-6 text-[#334357] text-[18px]">
                        {"Stay on top of things and revamp your work process with our game-changing feature. Get a bird's eye view with our customizable dashboard."} </p>
